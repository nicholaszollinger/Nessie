...
//     //----------------------------------------------------------------------------------------------------
//     EGraphicsResult             (*AllocateAndBindMemory) (RenderDevice& device, const ResourceGroupDesc& resourceGroup, GMemory* pOutAllocations);
//
//     //----------------------------------------------------------------------------------------------------
//     /// @brief : Populate resources with data (not for streaming!). 
//     //----------------------------------------------------------------------------------------------------
//     EGraphicsResult             (*UploadData) (DeviceQueue& queue, const TextureUploadDesc* pTextureUploads, const uint32 textureUploadNum, const BufferUploadDesc* pBufferUploads, const uint32 bufferUploadNum);
//
//     //----------------------------------------------------------------------------------------------------
//     /// @brief : Get information about video memory. 
//     //----------------------------------------------------------------------------------------------------
//     EGraphicsResult             (*QueryVideoMemoryInfo) (const RenderDevice& device, const EMemoryLocation location, VideoMemoryInfo& outVideoMemoryInfo);
// };
//
// //----------------------------------------------------------------------------------------------------
