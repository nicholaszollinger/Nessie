...
//
//         //----------------------------------------------------------------------------------------------------
//         /// @brief : Returns the first queue of the given type. 
//         ///	@returns : Returns "Unsupported" if the queue type is not available.
//         //----------------------------------------------------------------------------------------------------
//         EGraphicsResult         GetQueue(const EQueueType type, DeviceQueue*& outQueue) const;
//         
//         // //----------------------------------------------------------------------------------------------------
...
//
//     private:
//         using DeviceQueueArray = std::array<DeviceQueue*, static_cast<size_t>(EQueueType::MaxNum)>;
//         
...
//         DeviceQueueArray        m_deviceQueueArray{};
//
