...
namespace nes
{
    ...
    public:
        ...
        struct Triangle
        {
            ...
            Triangle() = default;
            inline Triangle(int index0, int index1, int index2, const Vec3* pPositions);
            ...
            //----------------------------------------------------------------------------------------------------
            inline bool IsFacing(const Vec3& position) const
            {
        ...
        public:
            ...
            //----------------------------------------------------------------------------------------------------
            Triangle* CreateTriangle(int index0, int index1, int index2, const Vec3* pPositions);
        ...
        using PointsBase = StaticArray<Vec3, kMaxPoints>;
        ...
        //		
        /// @brief : Specialized triangles array that keeps them sorted on the closest distance to the origin. 
        //----------------------------------------------------------------------------------------------------
        class TriangleQueue : public Triangles
        {
        public:
            //----------------------------------------------------------------------------------------------------
            /// @brief : Function to sort triangles on the closest distance to the origin. 
            //----------------------------------------------------------------------------------------------------
    ...
    public:
        ...
        //----------------------------------------------------------------------------------------------------
        Triangle*   FindFacingTriangle(const Vec3& position, float& outBestDistSqr);
    ...
    private:
        ...
        //----------------------------------------------------------------------------------------------------
        bool        FindEdge(Triangle* pFacingTriangle, const Vec3& vertex, Edges& outEdges);
    };
}
