...
//
//     template <FloatingPointType Type>
//     void DecomposeMatrix(const TMatrix4x4<Type>& matrix, TVector3<Type>& translation, Rotation<Type>& rotation, TVector3<Type>& scale);
//
//     template <FloatingPointType Type>
...
//
//     template <FloatingPointType Type>
//     TMatrix4x4<Type> ComposeTransformMatrix(const TVector3<Type>& translation, const Rotation<Type>& rotation, const TVector3<Type>& scale);
// }
//
// namespace nes::math
// {
...
//     //----------------------------------------------------------------------------------------------------
//     template <FloatingPointType Type>
//     void DecomposeMatrix(const TMatrix4x4<Type>& matrix, TVector3<Type>& translation, Rotation<Type>& rotation,
//         TVector3<Type>& scale)
//     {
//         TMatrix4x4<Type> copy(matrix);
//         scale = copy.ExtractScaling();
...
//
//     template <FloatingPointType Type>
//     TMatrix4x4<Type> ComposeTransformMatrix(const TVector3<Type>& translation, const Rotation<Type>& rotation,
