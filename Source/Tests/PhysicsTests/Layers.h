...
{
    static constexpr nes::CollisionLayer kUnused1    = 0;
    static constexpr nes::CollisionLayer kUnused2    = 1;
    static constexpr nes::CollisionLayer kUnused3    = 2;
    static constexpr nes::CollisionLayer kUnused4    = 3;
    static constexpr nes::CollisionLayer kNonMoving  = 4;
    static constexpr nes::CollisionLayer kMoving     = 5; 
    static constexpr nes::CollisionLayer kDebris     = 6; // Example: Debris collides with kNonMoving.
    static constexpr nes::CollisionLayer kSensor     = 7; // Sensors only collide with Moving objects.
    static constexpr nes::CollisionLayer kNumLayers  = 8;
}

namespace BroadPhaseLayers
{
    static constexpr nes::BroadPhaseLayer    kNonMoving(0);
    static constexpr nes::BroadPhaseLayer    kMoving(1);
    static constexpr nes::BroadPhaseLayer    kDebris(2);
    static constexpr nes::BroadPhaseLayer    kSensor(3);
    static constexpr nes::BroadPhaseLayer    kUnused(4);
    static constexpr uint                    kNumLayers(5);
}
...
{
public:
    virtual bool ShouldCollide(const nes::CollisionLayer layer1, const nes::CollisionLayer layer2) const override
    {
        switch (layer1)
        {
...
//----------------------------------------------------------------------------------------------------
class BroadPhaseLayerInterfaceTest final : public nes::BroadPhaseLayerInterface
{
    nes::BroadPhaseLayer m_layerToBroadPhase[PhysicsLayers::kNumLayers];
...
public:
    ...
    virtual nes::BroadPhaseLayer GetBroadPhaseLayer(const nes::CollisionLayer layer) const override
    {
...
class CollisionVsBroadPhaseLayerFilterTest final : public nes::CollisionVsBroadPhaseLayerFilter
{
public:
    virtual bool ShouldCollide(const nes::CollisionLayer collisionLayer, const nes::BroadPhaseLayer broadPhaseLayer) const override
    {
