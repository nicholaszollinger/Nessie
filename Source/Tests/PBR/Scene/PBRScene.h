...
namespace pbr
{
    ...
    {
        uint32      m_meshIndex = helpers::kInvalidSceneIndex;      // Index into the Scene's Mesh Instance array.
        uint32      m_materialIndex = helpers::kInvalidSceneIndex;  // Index into the Scene's Material array.
    };
    ...
    struct Scene
    {
        ...
        std::vector<MeshInstance>           m_meshes{};             // Array of meshes that can be used by instances.
        ...
        using AssetIDToIndicesMap = std::unordered_map<nes::AssetID, std::vector<uint32>, nes::UUIDHasher>;
        ...
        AssetIDToIndicesMap                 m_idToMeshInstanceIndices{};
    };
}
